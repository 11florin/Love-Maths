 ...
 * and after the user's answers hae been processed
 */
...
/**
 * Check the answer against first element in
...
/**
 * Gets the current tally of incorrect answers from the DOM and incrementes by 1
 */
function incrementWrongAnswer() {
  let oldScores = parseInt(document.getElementById("incorrect").innerText);
  document.getElementById("incorrect").innerText = ++oldScores;
}
